    ...
    <div ref={containerRef} className="relative min-h-screen bg-stone-950 flex flex-col justify-between">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-20 w-full">
        ...
        <div className="max-w-3xl mb-16">
          <span className="about-intro-reveal text-gold-400 text-xs font-bold uppercase tracking-[0.3em] block mb-4">
            Our Legacy
          </span>
          <h1 className="about-intro-reveal font-serif text-4xl md:text-6xl uppercase tracking-wide text-white mb-6">
            The Sourcing <br />
            <span className="italic text-gold-foil">Story & Studio</span>
          </h1>
          <p className="about-intro-reveal text-stone-400 text-sm leading-relaxed">
        ...
        <div className="about-story-section grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="about-story-col flex flex-col gap-6 text-xs text-stone-400 leading-relaxed font-sans">
        ...
        <section className="about-stats-section grid grid-cols-2 md:grid-cols-4 gap-6 border-y border-stone-900 py-12 mb-24">
          <div className="text-center">
            <span className="about-stat-number font-serif text-4xl md:text-5xl text-gold-400 font-bold block" data-value="15">0</span>
            <span className="text-[9px] text-stone-500 uppercase tracking-widest font-bold mt-2 block">Years of Legacy</span>
          </div>
          <div className="text-center">
            <span className="about-stat-number font-serif text-4xl md:text-5xl text-gold-400 font-bold block" data-value="500">0</span>
            <span className="text-[9px] text-stone-500 uppercase tracking-widest font-bold mt-2 block">Sq Ft Delivered (K)</span>
          </div>
          <div className="text-center">
            <span className="about-stat-number font-serif text-4xl md:text-5xl text-gold-400 font-bold block" data-value="120">0</span>
            <span className="text-[9px] text-stone-500 uppercase tracking-widest font-bold mt-2 block">Slab Varieties</span>
          </div>
          <div className="text-center">
            <span className="about-stat-number font-serif text-4xl md:text-5xl text-gold-400 font-bold block" data-value="98">0</span>
        ...
        <section className="timeline-section mb-24">
          <span className="text-gold-400 text-xs font-bold uppercase tracking-[0.3em] block mb-4 text-center">
            The Sourcing Journey
          </span>
          <h2 className="font-serif text-3xl md:text-5xl uppercase tracking-wide text-white mb-12 text-center">
            From Quarry <span className="italic text-gold-foil">to Living Room</span>
          </h2>
          ...
          <div className="relative border-l border-stone-900 ml-4 md:ml-32 py-8 space-y-12">
            {[
              ...
              <div key={idx} className="timeline-card relative pl-8 md:pl-12 group">
                {/* Timeline node */}
                <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-stone-950 border border-gold-400 group-hover:bg-gold-400 transition-colors duration-300" />
                ...
                <div className="bg-stone-900/20 border border-stone-900 rounded-xl p-6 md:p-8 hover:border-stone-850 hover:bg-stone-900/30 transition-all duration-300">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] text-gold-400 font-bold uppercase tracking-widest">Step {item.step}</span>
                    <span className="text-[9px] text-stone-600 uppercase font-sans tracking-wider">{item.location}</span>
                  </div>
                  <h4 className="font-serif text-lg md:text-xl text-white uppercase font-medium group-hover:text-gold-400 transition-colors mb-2">
                    {item.title}
                  </h4>
                  <p className="text-xs text-stone-400 leading-relaxed font-sans max-w-2xl">
                    {item.desc}
                  </p>
                </div>
              </div>
